	...
	String[] values = request.getParameterValues("rphone");
    String rnum = "";
     for(int i = 0;i<values.length-1;i++){
     	rnum += values[i]+",";
     }
     rnum+=values[values.length-1];
    ...
    if(action.equals("go")) {
        ...
        String user_id = base64Encode("belloyv"); // SMS아이디
        String secure = base64Encode("2bd3376ed96a99c2badbd950ebfd6f75");//인증키
        String msg = base64Encode(nullcheck(request.getParameter("msg"), ""));
        String rphone = base64Encode(rnum);
        ...
        out.println("<script>history.back(); history.back();</script>");
    }
    %>
